...
<input type="number" name="phone" id="phone" placeholder="phone no./தொலைபேசி எண்." size="10"/ required> 
...
<textarea cols="80" rows="5" placeholder="Current Address/தற்போதைய முகவரி" id="address" name="address" value="" >  
 ...
 <input type="email" placeholder="Enter Email/மின்னஞ்சல்" id="email" name="email" >  
    ...
    <button onclick="register('service_add','',firstname.value,lastname.value,gender.value,phone.value,address.value,email.value,psw.value,psw_repeat.value)" id="addupdate" class="registerbtn"><a href ="index.php">register/பதிவு</a></button>

</form>  
</div>
</body>
<script>
function register(action, id = '',firstname,lastname,gender,phone,address,email,psw,psw_repeat) {
