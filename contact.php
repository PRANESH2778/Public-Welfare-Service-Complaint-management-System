...
section {    background: lightblue ;    color: #000;    padding: 30px 0;}
.text-center{text-align:center;}
.section-title {    color: black;    font-size: 35px;    font-weight: bold;    text-transform: uppercase;}
...
.costom-btn {    background:#22c489;    border: 1px solid #22c489;    color: #ffffff;
